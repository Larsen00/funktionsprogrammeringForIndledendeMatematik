...
Signatur filen indeholder overloadings på de matematiske operationer, så de kan anvendes mellem på ligningsudtryk. Samt en funktion \textcolor{red}{eval} til at evaluere et ligningsudtryk. 
\lstinputlisting[
    language=FSharp,
    label={Number_fsi},
