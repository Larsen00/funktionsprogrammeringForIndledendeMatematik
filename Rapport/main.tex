...
let rec etf e p =
    ...
    | Add(a, b) -> 
      parenthesis p <| etf a false + "+" + etf b false |> parenthesis p
    | Sub(a, b) -> 
      parenthesis p <| etf a false + "-" + etf b true  |> parenthesis p
    | Mul(a, b) -> 
      parenthesis p <| etf a true  + "*" + etf b true  |> parenthesis p
    | Div(a, b) -> 
      parenthesis p <| etf a true  + "/" + etf b true  |> parenthesis p
