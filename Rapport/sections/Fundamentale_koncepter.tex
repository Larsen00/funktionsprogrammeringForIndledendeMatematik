...
F\# er en del af ML (Meta Language) familien af funktionsprogrammeringssprog, som bygger på typed lambda calculus\footcitetitle{lambda_typed}. Typed lambda calculus er en udvidelse af lambda calculus\footcitetitle{lambda}, som er et formelt system til at udtrykke beregninger.
...
\lstinputlisting[
    language=FSharp,
    label={valid1},
    caption={PBT af Ligning \eqref{udsagnslogik}. Begge sider skal være omgivet af parenteser, for at den er gyldig, da "$=$" har en højere præcedens end" $\&\&$"}
